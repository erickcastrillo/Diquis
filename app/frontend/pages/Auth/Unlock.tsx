...
export default function Unlock({ errors = {} }: Props) {
  ...
  return (
    <Fragment>
      <Head title={t("auth.unlock.title")} />
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <div className="text-center mb-6">
                <h1 className="text-3xl font-bold">{t("auth.unlock.title")}</h1>
