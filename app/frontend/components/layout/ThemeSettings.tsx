              ...
              >
                <span className="mb-2 rounded d-block">
                  <img
                    ...
                    src="/assets/images/theme/generic/default-light.png"
                    alt="Light theme"
                  />
                </span>
            ...
            <div className="col-4">
              ...
              >
                <span className="mb-2 rounded d-block">
                  <img
                    className="img-fluid img-prototype mb-0"
                    src="/assets/images/theme/generic/default-dark.png"
                    alt="Dark theme"
                  />
                </span>
          ...
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div className="form-check form-switch mb-0">
              <input
                ...
                onChange={(e) =>
                  updateConfig({ phoenixIsRTL: e.target.checked })
                }
              />
            </div>
          </div>
          ...
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div className="form-check form-switch mb-0">
              <input
                ...
                onChange={(e) =>
                  updateConfig({ phoenixSupportChat: e.target.checked })
                }
              />
            </div>
          </div>
          ...
          <div className="row gx-2">
            <div className="col-6">
              <input
                ...
                onChange={() =>
                  updateConfig({ phoenixNavbarPosition: "vertical" })
                }
              />
              <label
                className="btn d-inline-block btn-navbar-style fs-9"
            ...
            <div className="col-6">
              <input
                ...
                onChange={() =>
                  updateConfig({ phoenixNavbarPosition: "horizontal" })
                }
              />
              <label
                className="btn d-inline-block btn-navbar-style fs-9"
              ...
              >
                <span className="rounded d-block">
                  <img
                    className="img-fluid img-prototype d-dark-none"
                    src="/assets/images/theme/generic/top-default.png"
                    alt="Horizontal nav"
                  />
                  <img
                    className="img-fluid img-prototype d-light-none"
                    src="/assets/images/theme/generic/top-default-dark.png"
                    alt="Horizontal nav"
                  />
                </span>
