...
RSpec.describe Football::PlayerStatsJob, type: :job do
  ...
  describe '#perform' do
    context 'with valid arguments' do
      ...
      it 'logs the start and completion' do
        expect(Rails.logger).to receive(:info).with(/Starting Football::PlayerStatsJob/)
        expect(Rails.logger).to receive(:info).with(/Completed Football::PlayerStatsJob/)
    ...
    context 'when an error occurs' do
      ...
      it 'logs the error and re-raises it' do
        expect(Rails.logger).to receive(:error).with(/Error in Football::PlayerStatsJob/)
